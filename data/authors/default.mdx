...
<div className="flex flex-wrap items-center justify-start">
  <div className="justify-center pr-2 text-xl font-bold">I am best with:</div>
  <div className="pr-2 prose-img:m-0">
...
<div className="flex flex-wrap items-center justify-start">
  <div className="justify-center pr-2 text-xl font-bold">I am good with:</div>
  <div className="pr-2 prose-img:m-0">
...
<div className="flex flex-wrap items-center justify-start">
  <div className="justify-center pr-2 text-xl font-bold">I am familiar with:</div>
  <div className="pr-2 prose-img:m-0">
...
<div className="flex flex-wrap items-center justify-start">
  <div className="justify-center pr-2 text-xl font-bold">I am learning:</div>
  <div className="pr-2 prose-img:m-0">
