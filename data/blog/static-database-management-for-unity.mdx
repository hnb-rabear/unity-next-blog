...
[Download example excel from GitHub](https://github.com/nbhung100914/ExcelToUnity/blob/main/ExcelToUnity/Document/DataConverterExample.xlsx)
...
- idString là kết hợp của 2 cột `idstring` và `relativeId`. vd `content_1`, `content_2`, ...
- `HERO_1`, `HERO_2`, ... là tham chiếu tới id tương ứng trong sheet IDs. Như vậy idString tương ứng sẽ là `hero_name_1`, `hero_name_2`, ...
