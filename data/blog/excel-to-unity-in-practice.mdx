...
Vậy là kết thúc phần này, với các tính năng đã trình bày, bạn hoàn toàn có khả năng thiết kế và quản lý cơ sở dữ liệu tĩnh cho một trò chơi Casual, thậm chí là trò chơi Mid-core. Trong bài viết sắp tới, tôi sẽ giới thiệu các phương pháp nâng cao để khai thác tối đa sức mạnh của công cụ này.
