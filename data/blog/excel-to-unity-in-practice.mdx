...
- Tạo một ScriptableObject, có nhiệm vụ load và save Json Data vào các Serializable Object trên
...
```cs
// NOTE: hàm này để Load data trên Unity Editor, nên nó phải nằm trong thư mục Editor hoặc phải nằm trong #if UNITY_EDITOR
