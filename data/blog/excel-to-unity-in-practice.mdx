---
title: Excel2Unity - Demo Unity Project
date: 2023-11-24
lastmod: 2023-11-24
...
<div className="flex flex-wrap items-center justify-center p-0">
  ![LocalizationText Component](/media/excel-to-unity-basic-localization-component.png)
</div>
...
<div className="flex flex-wrap items-center justify-center p-0">
  ![Separated Localization](/media/excel-to-unity-basic-exported-multi-localization.png)
</div>
...
<div className="flex flex-wrap items-center justify-center p-0">
  ![Separated Localization](/media/excel-to-unity-basic-localization-component-2.png)
</div>
