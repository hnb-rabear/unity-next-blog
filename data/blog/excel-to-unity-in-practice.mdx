...
<div className="flex flex-wrap items-center justify-center">
  <div className="px-1 py-0">
    ![Exported scripts](/media/excel-to-unity-basic-exported-scripts.png)
  </div>
  <div className="px-1 py-0">
    ![Exported JSON Data](/media/excel-to-unity-basic-exported-data.png)
  </div>
  <div className="px-1 py-0">
    ![Exported localization](/media/excel-to-unity-basic-exported-localization.png)
  </div>
</div>
...
<div className="flex flex-wrap justify-center">
  <div className="px-1">![ScriptableObject](/media/excel-to-unity-basic-scriptable-object.png)</div>
  <div className="px-1">![Load Data](/media/excel-to-unity-basic-load-data.png)</div>
</div>
...
Trong trướng hợp bạn chọn Separate Localization trong bảng Settings. Localization data và Localization scripts xuất ra sẽ trông như sau.

<div className="flex flex-wrap items-center justify-center p-0">
  ![multi localization](/media/excel-to-unity-basic-exported-multi-localization.png)
</div>
...
<div className="flex flex-wrap items-center justify-center p-0">
  ![font japanese](/media/excel-to-unity-basic-localization-component-2.png)
</div>
...
<div className="flex flex-wrap items-center justify-center">
  <div className="m-0 p-0">![font japanese](/media/excel-to-unity-basic-font-jp.png)</div>
  <div className="m-0 p-0">![font korean](/media/excel-to-unity-basic-font-kr.png)</div>
</div>

Vậy là kết thúc phần này, với các tính năng đã trình bày, bạn đã có đủ công cụ để xây dựng một Static Database với Excel, đáp ứng đủ cho bất cứ game Casual và Mid-core nào. Trong bài viết sắp tới, tôi sẽ giới thiệu các phương pháp nâng cao để khai thác tối đa sức mạnh của công cụ này.
